...
import tc, {tachyonsToCss as tcCss, addSkin} from '../src/';
import tachyonsConfig  from '../src/config';
import { addMediaQuery } from '../src/tachyons/mediaQueries';
...
storiesOf('Tachyons in JS', module)
.add('Examples', () => {
  return <div>
